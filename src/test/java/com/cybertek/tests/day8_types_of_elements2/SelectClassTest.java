...
public class SelectClassTest {
    ...
    public void test1(){
        ...
        //create select class object by passing the element as a constructor
    ...
    public void test2() throws InterruptedException {
        ...
        Assert.assertEquals(actualOption,expectedOption,"Verify that first option is select a state ");
